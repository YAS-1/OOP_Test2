...
def game_scenario(vehicle, HeroCharacter):
    print("\n🎮🎮🎮🎮🎮🎮VIRTUAL COP🎮🎮🎮🎮🎮🎮\n")
    print("")
    print("YOUR ARE A POLICE OFFICER AND YOUR MISSION IS TO CHASE AND APPREHEND THE CRIMINAL ON THE RUN")
    print("")
    HeroCharacter.interact("gun")
    print("")
    print(f"{HeroCharacter.name} gets his gun")
    print("")
    HeroCharacter.move((2,5))
    print("")
    print("Enter your car and drive to chase after the criminal")
    print("")
    ...
    print("")
    print(f"\n{HeroCharacter.name} has caught up to the criminal now stop him using your weapon\n")
    print("")
    ...
    if HeroCharacter.health <= 0:
        print("")
        print("MISSION FAILED: You were killed by the criminal")
    else:
        print("")
        print("MISSION COMPLETE: THE CRIMINAL IS DOWN")
    

# IMPLEMENTATION
# Object for class Character
character1 = Character("Lynn", 20, (0, 0))

character1.move((2, 10))
character1.attack  
character1.interact("stick") 
print("---------------------------------------")

# Object for class Vehicle
vehicle1 = Vehicle("Rolls Royce", 200, 0)
...
hero1 = HeroCharacter("Flash", 100, (0, 0))
hero1.double_jump  
hero1.fast_run  
print("----------------------------------------")

# Main game scenario (including Hero and Vehicle)
cop = HeroCharacter("Lynn", 100, (0, 0))
copCar = Vehicle("Rolls Royce", 200, 50)
